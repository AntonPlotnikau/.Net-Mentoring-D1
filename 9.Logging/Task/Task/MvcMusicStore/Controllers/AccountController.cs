...
namespace MvcMusicStore.Controllers
{
    ...
    {
		private readonly ILogger logger = new XmlLogger(LogSettings.Settings);
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
					logger.Log("SignIn", LoggingLevel.Debug);
                    await SignInAsync(user, model.RememberMe);

                    return RedirectToLocal(returnUrl);
                }
				logger.Log("Invalid username or password.", LoggingLevel.Warn);
        ...
        public async Task<ActionResult> Manage(ManageMessageId? message)
        {
            switch (message)
            {
                case ManageMessageId.ChangePasswordSuccess:
					logger.Log("Your password has been changed.");
                    ViewBag.StatusMessage = "Your password has been changed.";
                    break;
                case ManageMessageId.SetPasswordSuccess:
					logger.Log("Your password has been set.");
					ViewBag.StatusMessage = "Your password has been set.";
                    break;
                case ManageMessageId.RemoveLoginSuccess:
					logger.Log("The external login was removed.");
					ViewBag.StatusMessage = "The external login was removed.";
                    break;
                case ManageMessageId.Error:
					logger.Log("An error has occurred.", LoggingLevel.Error);
